...
namespace TheRig.Data.Providers
{
    public class DataProvider : IDataProvider
    {
        public List<Motherboard> GetMotherboards()
        {
            ...
            {
                new Motherboard {Id =1, RamTypeId = 1, CpuTypeId = 1, GraphicsTypeId = 1, SoundTypeId = 3, MaxCpu = 1, MaxGraphics = 1, MaxRam = 2, MaxSound = 1},
                new Motherboard {Id= 2, RamTypeId = 2, CpuTypeId = 2, GraphicsTypeId = 2, SoundTypeId = 2, MaxCpu = 1, MaxGraphics = 1, MaxRam = 4, MaxSound = 1},
                  new Motherboard {Id= 3, RamTypeId = 2, CpuTypeId = 2, GraphicsTypeId = 3, SoundTypeId = 1, MaxCpu = 2, MaxGraphics = 2, MaxRam = 6, MaxSound = 1}
            };
        }
